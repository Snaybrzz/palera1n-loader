...
struct CreditsSheetView: View {
    ...
    var credits: [Person] = [
        Person(name: "pwnd2e", icon: URL(string: "https://pbs.twimg.com/profile_images/1604510765968461830/MUDz1xPH_400x400.jpg")!, role: "palera1n Owner", link: URL(string: "https://twitter.com/pwnd2e")!),
